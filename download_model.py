...
def show_usage():
    ...
    print("")
    print("例:")
    print("  python download_model.py Qwen/Qwen2.5-VL-3B-Instruct")
    print("  python download_model.py Qwen/Qwen2-1.5B-Instruct")
...
def main():
    ...
    if success:
        ...
        print(f"   ./run_vllm.sh {args.model_name}")
        print("")
        print("2. または、別のモデルをダウンロード:")
